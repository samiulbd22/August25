...
const members = {
    ...
    serviceBill     :20,
    othersBill      :0,
    runningMonth    :"August-25",
    previousMonth   :"July-25", // new addDecember link https://grabify.link/38DB4J
    upComingMonth   :"September 1,2025",
    runningMealRate :55,
...
//Continue for mass calculating {"04/08/25-Cash":4550}    
    "01922362569":{
        ...
        payment             :{"10/08/25-DBBL":2000,"20/08/25-Cash":660,"24/08/25-Cash":550,"26/08/25-Cash":300},
        // running month
        stay_cost       :2000,
        garage_cost     :0,
    ...
    "01797816501":{
        ...
        payment             :{"07/08/25-Cash":4000,"27/08/25-Cash":500},
        // running month{"04/08/25-Cash":4550}
        stay_cost       :2300,
        garage_cost     :0,
        running_payable :2486,
        running_paid    :4500,
        running_meal    :34,
        // method calling
        preMonth,
    ...
    "01704351658":{
        ...
        post_payable        :3138,
        previous_paid       :5000,
        previous_dining_cost:3180,
        payment             :{"12/08/25-Cash":5500},
        // running month
        stay_cost       :2700,
        garage_cost     :0,
        running_payable :4678,
        running_paid    :5500,
        running_meal    :52,
        // method calling
        preMonth,
    ...
    "01581515641":{//01644377150
        ...
        post_payable        :4333,
        previous_paid       :6900,
        previous_dining_cost:3172,
        payment             :{"13/08/25-Cash":4200,"18/08/25-Cash":2000,"23/08/25-Cash":1000},
        // running month
        stay_cost       :3250,
        garage_cost     :0,
        running_payable :4515,
        running_paid    :7200,
        running_meal    :56,
        // method calling
        preMonth,
    ...
    "01921567438":{
        ...
        previous_paid       :5200,
        previous_dining_cost:1325,
        payment             :{"04/08/25-Cash":4550,"14/08/25-Cash":2000,"21/08/25-Cash":500},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :4549,
        running_paid    :7050,
        running_meal    :54,
        // method calling
        preMonth,
    ...
    "01934147404":{
        ...
        previous_paid       :5000,
        previous_dining_cost:1325,
        payment             :{"02/08/25-Cash":2000,"09/08/25-Cash":3500,"26/08/25-Cash":500},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :4211,
        running_paid    :6000,
        running_meal    :29,
        // method calling
        preMonth,
	...
	"01639523533":{
        ...
        payment             :{"08/08/25-Cash":3500,"13/08/25-Cash":3000,"20/08/25-Cash":1000},
        // running month {"01/07/24-Cash":500}
        stay_cost       :2800,
        garage_cost     :0,
        running_payable :5600,
        running_paid    :7500,
        running_meal    :24,
        // method calling
        preMonth,
    ...
    "01920056090":{
        ...
        payment             :{"04/08/25-Cash":3000,"06/08/25-Cash":2000},
        // running month
        stay_cost       :2400,
        garage_cost     :0,
        running_payable :2541,
        running_paid    :5000,
        running_meal    :22,
        // method calling
        preMonth,
	...
	"01821245430":{
        ...
        payment             :{"07/08/25-Cash":1000,"13/08/25-Cash":1000,"17/08/25-Cash":500},
        // running month
        stay_cost       :0,
        garage_cost     :0,
        running_payable :336,
